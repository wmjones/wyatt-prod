...
const AuthConfigError: React.FC<AuthConfigErrorProps> = ({
  ...
  if (isPlaceholderUserPoolId || isPlaceholderClientId) {
    errorTitle = "Authentication Configuration Error";
    errorMessage = "The application's authentication service is not properly configured.";
    actionMessage = "Please contact the administrator with error code: COGNITO_CONFIG_MISSING";
  ...
  return (
    <Card className="w-full max-w-md p-6 mx-auto mt-8 bg-white shadow-lg rounded-lg">
